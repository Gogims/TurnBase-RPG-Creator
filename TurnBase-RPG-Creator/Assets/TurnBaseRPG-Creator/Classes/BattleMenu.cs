...
public class BattleMenu : Menus {
    /// <summary>
    /// Menu para el listado de habilidades
    /// </summary>
   // ScrollNavigator<Ability> AbilityMenu;
    /// <summary>
    /// Menu para el listado de item
    /// </summary>
    ScrollNavigator<AbstractUsable> ItemMenu;
    /// <summary>
    ...
    public void Init(Player p){
        ...
        ItemMenu = new ScrollNavigator<AbstractUsable>();
        SelectionMenu = new Navigator();
        ItemMenu.Init(new Vector3(9, 59), new Vector3(105, 68), -30, 0, 5, GameObject.Find("List Panel").transform.FindChild("Arrow2").gameObject, GameObject.Find("List Panel").transform.FindChild("NextArrow").gameObject, GameObject.Find("List Panel").transform.FindChild("PrevArrow").gameObject, GameObject.Find("List Panel"));
        ...
        ItemMenu.setList(p.Items.Usables);
    }
    /// <summary>
    /// 
    /// </summary>
